...
'''https://huggingface.co/transformers/model_doc/bert.html?highlight=bertforsequenceclassification#bertmodel
'''
...
class BERT_Model(nn.Module):
    ...
    def save_model(self):
        ...
        model_to_save = self.model.module if hasattr(self.model, 'module') else self.model  # 考虑到分布式/并行（distributed/parallel）训练
